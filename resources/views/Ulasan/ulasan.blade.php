...
<section class="ulasan-pengguna ">
    ...
    <p>Dengan fitur ini, pengguna dapat berbagi pengalaman, pandangan, dan penilaian mereka terhadap suatu produk, layanan, atau pengalaman</p>
</section>
  </main>
  ...
  <form action="{{url('store')}}" method="POST">
    ...
    <div class="card-body">
        <style>
            .form-group label {
                text-align: left;
                display: block; /* Membuat label menjadi blok agar rata kiri */
            }
        </style>
        ...
        <div class="card-footer" style="text-align: right;">
            <a href="{{ route('guest') }}" class="btn btn-success" id="cancelBtn">Cancel</a>
