    ...
    <head>
        ...
        <nav id="navbar" class="navbar">
                ...
                <div class="nav-profile">
                    ...
                    <img src="/img/profile_1.jpg" alt="" class="profile-pic"> <a href="/profile" style="color: black; padding:0; margin-top36px;">Tripoli</a>
                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                <div class="text-center">
                                    <img class="profile-user-img img-fluid img-circle" src="{{ asset('/img/profile_1.jpg')}}" alt="User profile picture">
                                </div>
