...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav id="navbar" class="navbar">
                <ul class="nav-menu">
                    ...
                    <li><a class="nav-link active" href="/admin/dashboard">Dashboard</a></li>
    ...
    <div class="nav-kanan">
        ...
        <ul>
            ...
            @else
                ...
                <li><a class="btn2" style="color: #3B7C0F ; font-size:16px;" href="/admin/profile">{{ Auth::user()->name }}</a></li>
